...
class DocumentRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
        ...
        $validator->after(function ($validator) {
            ...
            $documentType = Option::byTeam()->whereType('document_type')->whereUuid($this->type)->getOrFail(__('employee.document_type.document_type'), 'type');
            ...
            if (! app()->environment('testing') && ! $attachedMedia) {
